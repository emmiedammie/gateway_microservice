...
import com.auth0.visit.repository.VisitRepository;
import com.auth0.visit.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.auth0.visit.domain.Visit}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class VisitResource {
    ...
    private static final String ENTITY_NAME = "rotaNvisitVisit";
