...
import com.auth0.admin.domain.Client;
import com.auth0.admin.repository.ClientRepository;
import com.auth0.admin.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.auth0.admin.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClientResource {
    ...
    private static final String ENTITY_NAME = "adminClient";
